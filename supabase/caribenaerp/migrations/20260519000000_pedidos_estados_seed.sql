-- =============================================================================
-- Pedidos (Fase 1) — Solo schema cucinaerp, solo empresa Cucina del Cuore.
...
BEGIN
  ...
  SELECT id INTO v_modulo_proyectos_id FROM cucinaerp.modulos WHERE slug = 'proyectos';
  IF v_modulo_proyectos_id IS NULL THEN
    RAISE EXCEPTION 'Slug proyectos no existe en cucinaerp.modulos';
  END IF;
  ...
  UPDATE cucinaerp.proyecto_estados
  SET activo = false
