        ...
        <ConfigFormCard>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <SelectField name="moneda_base" value={form.moneda_base} onChange={handleChange} className={F_SELECT}>
            ...
            <div>
              ...
              <SelectField name="formato_fecha" value={form.formato_fecha} onChange={handleChange} className={F_SELECT}>
        ...
        <ConfigFormCard>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <SelectField name="timezone" value={form.timezone} onChange={handleChange} className={F_SELECT}>
            ...
            <div>
              ...
              <SelectField name="idioma_default" value={form.idioma_default} onChange={handleChange} className={F_SELECT}>
